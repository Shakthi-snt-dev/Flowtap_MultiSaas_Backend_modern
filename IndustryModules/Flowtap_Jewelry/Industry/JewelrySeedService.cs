...
/// <summary>
/// Plugin seeder for the Jewelry industry.
/// Registered in DI by AddJewelryModule() and discovered by SeedIndustryDataCommandHandler.
/// </summary>
public class JewelrySeedService : IIndustryDataSeeder
{
    public IndustryType Industry => IndustryType.Jewelry;
    ...
    {
        // Gold Jewellery
        var gold = new ProductCategory { CompanyId = companyId, Name = "Gold Jewellery", SortOrder = 1, IsSubCategoryExist = true, IsActive = true };
        ...
        // Silver Jewellery
        var silver = new ProductCategory { CompanyId = companyId, Name = "Silver Jewellery", SortOrder = 2, IsSubCategoryExist = true, IsActive = true };
        ...
        // Diamond Jewellery
        var diamond = new ProductCategory { CompanyId = companyId, Name = "Diamond Jewellery", SortOrder = 3, IsSubCategoryExist = true, IsActive = true };
        ...
        // Gemstone Jewellery
        var gemstone = new ProductCategory { CompanyId = companyId, Name = "Gemstone Jewellery", SortOrder = 4, IsDirectProductExist = true, IsActive = true };
        context.ProductCategories.Add(gemstone);

        // Antique & Kundan
        var antique = new ProductCategory { CompanyId = companyId, Name = "Antique & Kundan", SortOrder = 5, IsDirectProductExist = true, IsActive = true };
        context.ProductCategories.Add(antique);

        // Sample Products
        context.Products.AddRange(
            new Product { CompanyId = companyId, CategoryId = diamondRings.Id,   Name = "Solitaire Diamond Engagement Ring (1 Carat)", Kind = ProductKind.Accessory, SKU = "JWL-DM-RNG-01",  DefaultCostPrice = 1200.00m, DefaultSalePrice = 2999.00m, IsSerialized = true,  IsUniversal = true, IsActive = true, PublishStatus = ProductPublishStatus.Published },
            new Product { CompanyId = companyId, CategoryId = goldNecklaces.Id,  Name = "22K Yellow Gold Rope Chain (24 inch)",        Kind = ProductKind.Accessory, SKU = "JWL-GD-CHN-22K", DefaultCostPrice = 450.00m,  DefaultSalePrice = 850.00m,  IsSerialized = true,  IsUniversal = true, IsActive = true, PublishStatus = ProductPublishStatus.Published },
            new Product { CompanyId = companyId, CategoryId = silverRings.Id,   Name = "Sterling Silver Infinity Ring",               Kind = ProductKind.Accessory, SKU = "JWL-SV-RNG-INF", DefaultCostPrice = 12.00m,   DefaultSalePrice = 49.00m,   IsSerialized = false, IsUniversal = true, IsActive = true, PublishStatus = ProductPublishStatus.Published }
        );
    }
}
