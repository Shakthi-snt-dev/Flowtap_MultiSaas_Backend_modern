...
namespace Flowtap_Jewelry.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class InitialJewelry : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MetalExchangeTransactions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    LocationId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    PurityPercent = table.Column<decimal>(type: "numeric", nullable: false),
                    NetWeightGrams = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MetalExchangeTransactions", x => x.Id);
                });
