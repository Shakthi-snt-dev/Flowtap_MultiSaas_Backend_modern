...
namespace Flowtap_Repair.Persistence.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JsonItems = table.Column<string>(type: "text", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryServiceId = table.Column<Guid>(type: "uuid", nullable: true),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    DeviceDetails_DeviceType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DeviceDetails_Brand = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DeviceDetails_Model = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DeviceDetails_Serial = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    DeviceDetails_Modification = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    DeviceDetails_Appearance = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    DeviceDetails_Password = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    DeviceDetails_Equipment = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    MastersNotes = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    ExecutorEmployeeId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    PreRepairChecklist = table.Column<string>(type: "text", nullable: true),
                    AccessoryList = table.Column<string>(type: "text", nullable: true),
                    SaleId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Symptom = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    PossibleCause = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    StandardSolution = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TechnicalFaults", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeviceModels_DeviceModels_ParentModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiresInventory = table.Column<bool>(type: "boolean", nullable: false),
                    InventoryProductId = table.Column<Guid>(type: "uuid", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsUniversal = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "ServiceTicketItems",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TicketId = table.Column<Guid>(type: "uuid", nullable: false),
                    ItemReferenceId = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTicketItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceTicketItems_ServiceTickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTicketPartUsages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceTicketPartUsages_ServiceTickets_ServiceTicketId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketTimeLogs_ServiceTickets_TicketId",
                        column: x => x.TicketId,
                        principalTable: "ServiceTickets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDeviceModelMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductDeviceModelMappings_DeviceModels_DeviceModelId",
                        column: x => x.DeviceModelId,
                        principalTable: "DeviceModels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductDeviceModelMappings_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ServiceDeviceModelMappings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceDeviceModelMappings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServiceDeviceModelMappings_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicePartRequirements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServicePartRequirements_Services_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceModels_ParentModelId",
                table: "DeviceModels",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDeviceModelMappings_DeviceModelId",
                table: "ProductDeviceModelMappings",
                column: "DeviceModelId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDeviceModelMappings_ProductId_DeviceModelId",
                table: "ProductDeviceModelMappings",
                columns: new[] { "ProductId", "DeviceModelId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceDeviceModelMappings_ServiceId_DeviceModelId",
                table: "ServiceDeviceModelMappings",
                columns: new[] { "ServiceId", "DeviceModelId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ServicePartRequirements_ServiceId",
                table: "ServicePartRequirements",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTicketItems_TicketId",
                table: "ServiceTicketItems",
                column: "TicketId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceTicketPartUsages_ServiceTicketId",
                table: "ServiceTicketPartUsages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkTaskTags_WorkTaskId",
                table: "WorkTaskTags",
                column: "WorkTaskId");
        }
