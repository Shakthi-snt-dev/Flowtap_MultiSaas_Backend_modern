...
public static class MedicalSeeder
{
    ...
    {
        // --- Medicines ---
        var medicines = new ProductCategory
        {
            CompanyId = companyId,
            Name = "Medicines",
            SortOrder = 1,
        ...
        // --- Consumables ---
        var consumables = new ProductCategory
        {
            CompanyId = companyId,
            Name = "Consumables",
            SortOrder = 3,
        ...
        // --- Lab Tests ---
        var labTestsCat = new ProductCategory
        {
            CompanyId = companyId,
            Name = "Lab Tests",
            SortOrder = 4,
        ...
        context.Products.AddRange(
            ...
            {
                CompanyId = companyId,
                CategoryId = glovesCat.Id,
                Name = "Disposable Nitrile Examination Gloves (Box of 100)",
                Kind = ProductKind.Accessory,
                SKU = "MED-CN-GLV",
                DefaultCostPrice = 2.50m,
                DefaultSalePrice = 12.50m,
                IsSerialized = false,
                IsUniversal = true,
                IsActive = true,
                PublishStatus = ProductPublishStatus.Published
